...
HELM_STABLE_RELEASE_URL="https://get.helm.sh/helm-v3.5.4-darwin-amd64.tar.gz"
...
tar -zxvf "${root}/tmp/helm.tar.gz" && mv darwin-amd64/helm "${root}/tmp/bin/helm" && rm -rf darwin-amd64
